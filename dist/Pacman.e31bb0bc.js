...
function randomMovement(position, direction, objectExist) {
  var dir = direction;
  var nextMovePos = position + dir.movement; // create an array from the directions objet keys
...
},{"./setup":"setup.js"}],"Character.js":[function(require,module,exports) {
"use strict";
...
var Pacman = /*#__PURE__*/function (_Character) {
  ...
  function Pacman(speed, startPos) {
    ...
    return _super.call(this, speed, startPos);
  }
...
var _default = Pacman;
exports.default = _default;
},{"./setup":"setup.js","./Character":"Character.js"}],"Ghost.js":[function(require,module,exports) {
"use strict";
...
var _default = Ghost;
exports.default = _default;
},{"./setup":"setup.js","./Character":"Character.js"}],"sounds/munch.wav":[function(require,module,exports) {
...
var gameBoard = _Gameboard.default.createGameBoard(gameGrid, _setup.LEVEL); // Sounds
...
function gameLoop(pacman, ghosts) {
  ...
  } // Change ghosts scaremode depending on powerpill
  ...
  } // Check if all dots are been eaten
...
},{"./setup":"setup.js","./ghostMoves":"ghostMoves.js","./Gameboard":"Gameboard.js","./Pacman":"Pacman.js","./Ghost":"Ghost.js","./sounds/munch.wav":"sounds/munch.wav","./sounds/death.wav":"sounds/death.wav","./sounds/pill.wav":"sounds/pill.wav","./sounds/eat_ghost.wav":"sounds/eat_ghost.wav","./sounds/game_start.wav":"sounds/game_start.wav"}],"../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
